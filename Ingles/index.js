...
function oprimir_btn(i) {
  ...
  if (posibles_respuestas[i] === pregunta.respuesta) {
    // Si la respuesta es correcta, actualizar el contador
    preguntas_correctas++;
    btn_correspondiente[i].style.background = "lightgreen";
  } else {
    // Si la respuesta es incorrecta, resaltar la respuesta correcta
    for (let j = 0; j < 4; j++) {
  ...
  // Esperar un tiempo antes de avanzar a la siguiente pregunta
  setTimeout(() => {
    reiniciar();
