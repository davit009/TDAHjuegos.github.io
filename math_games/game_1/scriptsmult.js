...
function comenzar(){
    ...
    // genera la multiplicación - Numeros aleatorios entre 0 y 9
    ...
    if(indiceOpCorrecta == 0){
        ...
        op2.innerHTML = respuesta + Math.round(Math.random()*3) + 1;
        op3.innerHTML = respuesta + Math.round(Math.random()*3) + 1;
    }
    if(indiceOpCorrecta == 1){
        op1.innerHTML = respuesta + Math.round(Math.random()*3) + 1;
